...

{
  ...
  users.groups = {
    media = {
      gid = 988;
    }; # bulk media read/write
    svc = {
      gid = 989;
    }; # generic service group
    private = {
      gid = 987;
    }; # restricted private shares — add users explicitly
    nextcloud = {
      gid = 990;
    };
    immich = {
    ...
    jellyfin = {
      gid = 992;
    }; # NixOS jellyfin module creates this too; keep in sync
    ha = {
      gid = 993;
    };
    qbt = {
  ...
  users.users = {
    ...
    frigate = {
      ...
      linger = true;
      home = "/var/lib/containers/frigate";
      createHome = true;
      subUidRanges = [
        {
          startUid = 331072;
      ...
      subGidRanges = [
        ...
        }
        {
          startGid = 26;
          count = 1;
        } # video — /dev/dri access
        {
          startGid = 303;
          count = 1;
        } # render — /dev/dri access
      ];
    };
    ...
    searxng = {
      ...
      isSystemUser = true;
      linger = true;
      home = "/var/lib/containers/searxng";
      createHome = true;
      subUidRanges = [
        {
          startUid = 396608;
    ...
    homepage = {
      ...
      isSystemUser = true;
      linger = true;
      home = "/var/lib/containers/homepage";
      createHome = true;
      subUidRanges = [
        {
          startUid = 462144;
    ...
    authentik = {
      ...
      isSystemUser = true;
      linger = true;
      home = "/var/lib/containers/authentik";
      createHome = true;
    ...
    bitmagnet = {
      ...
      isSystemUser = true;
      linger = true;
      home = "/var/lib/containers/bitmagnet";
      createHome = true;
      subUidRanges = [
        {
          startUid = 593216;
